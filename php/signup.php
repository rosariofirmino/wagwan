        ...
        <div class="col-sm-4">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                <div class="form-group">
                    <label>Email</label>
                    <input type="text" name="email" onkeyup="email_err(this.value)" class="form-control <?php echo (!empty($email_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $email; ?>">
                    <p class="text-danger" id="email_err"><?php echo $email_err; ?></p>
                </div>   
                <div class="form-group">
                    <label>Username</label>
                    <input type="text" name="username" onkeyup="username_err(this.value)" class="form-control <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $username; ?>">
                    <p class="text-danger" id="username_err"><?php echo $username_err; ?></p>
                </div>   
                <div class="form-group">
                    <label>Password</label>
                    <input type="password" name="password" id="password" onkeyup="password_err(this.value)" class="form-control <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $password; ?>">
                    <p class="text-danger" id="password_err"><?php echo $password_err; ?></p>
                </div>
                <div class="form-group">
                    <label>Confirm Password</label>
                    <input type="password" name="verifyPassword" onkeyup="ver_password_err(document.getElementById('password').value, this.value)" class="form-control <?php echo (!empty($confirm_password_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $confirm_password; ?>">
                    <p class="text-danger" id="ver_password_err"><?php echo $confirm_password_err; ?></p>
                </div>
